...
#define CUSTOM_MACHINE_NAME "MPCNC" //MPCNC
...
//  #define  DEFAULT_Kd 83.62 //MPCNC
  #define  DEFAULT_Kp 11.64
  #define  DEFAULT_Ki 0.60
  #define  DEFAULT_Kd 56.93
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop. BOB
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 4535.44, 200 }    // BOB
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 190, 190, 8.5, 25 }         // BOB
 ...
 */
#define DEFAULT_ACCELERATION          400    // X, Y, Z and E acceleration for printing moves MPCNC
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   500    // X, Y, Z acceleration for travel (non printing) moves MPCNC
...
//#define Z_ENDSTOP_SERVO_NR 0   // BOB
//#define Z_SERVO_ANGLES {0,160} // Z Servo Deploy and Stow angles. BOB
...
//    O-- FRONT --+
//  (0,0)
#define X_PROBE_OFFSET_FROM_EXTRUDER 57      // X offset: -left  +right  [of the nozzle]
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // BOB
...
#define X_MIN_POS -100   //BOB
#define Y_MIN_POS -20   //BOB
#define Z_MIN_POS  -1   //BOB
#define X_MAX_POS 300   //BOB
#define Y_MAX_POS 220   //BOB
...
//#define AUTO_BED_LEVELING_BILINEAR  // BOB
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_NUM_X_POINTS 5   // Don't use more than 15 points per axis, implementation limited.
  #define UBL_MESH_NUM_Y_POINTS 5
...
#define MANUAL_X_HOME_POS -130  // BOB
#define MANUAL_Y_HOME_POS -20   // BOB
#define MANUAL_Z_HOME_POS 0 // Distance between the nozzle to printbed after homing. BOB
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 190 //MPCNC
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 100, 80, 20 }
#endif
...
//
#define NUM_SERVOS 1 // Servo index starts with 0 for M280 command. BOB
